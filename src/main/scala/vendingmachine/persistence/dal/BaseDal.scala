package vendingmachine.persistence.dal
...
import vendingmachine.persistence.entities.{BaseEntity, BaseTable}
import vendingmachine.utils.{DbModule, Profile}
...
class BaseDalImpl[T <: BaseTable[A], A <: BaseEntity](tableQ: TableQuery[T])(implicit val db:
JdbcProfile#Backend#Database, implicit val profile: JdbcProfile) extends BaseDal[T, A] with Profile with DbModule {
